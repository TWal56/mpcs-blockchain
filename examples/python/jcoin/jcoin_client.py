...
class TxnCast(jcoin_pb2_grpc.TxnCastServicer):
    ...
    txn_mempool = {}
    print('test running a function when TxnCast is instantiated 1')
    ...
    print('test running a function when TxnCast is instantiated 2')
...
# ??? JUST ADD ANOTHER THREAD FOR THE GRPC SERVER?
